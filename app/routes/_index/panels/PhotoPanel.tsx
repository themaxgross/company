    ...
    <Panel>
      <div className="grid md:grid-cols-2 gap-4 px-4 md:px-10 mb-8 md:mb-20">
        <div className="flex flex-col justify-center items-center">
          ...
          text-gray-900 dark:text-brand-primary-50 mb-6"
          >
            Looking good has never been so easy.
          </h3>
          <p className="text-xl text-gray-900 dark:text-brand-primary-50 mb-6">
            If your project calls for it, I can provide photography services for
            any of your needs.
          </p>
          <a
            href="https://photos.leoji.company"
            className="text-xl text-gray-900 dark:text-brand-primary-50 font-raleway mt-1 mb-3"
